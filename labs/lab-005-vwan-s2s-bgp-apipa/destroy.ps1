# labs/lab-005-vwan-s2s-bgp-apipa/destroy.ps1
# Destroys all resources created by lab-005
...
Write-Host ""
Write-Host "Lab 005: Destroy Resources" -ForegroundColor Cyan
...
# Clean up local data
$dataDir = Join-Path $RepoRoot ".data\lab-005"
